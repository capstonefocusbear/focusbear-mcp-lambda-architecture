...
export class UpdateTableActivitiesAddColumnImpactCategory1692585660188 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      "CREATE TYPE \"public\".\"impact_category_enum\" AS ENUM('hours_of_sleep', 'energy_level_upon_awakening', 'mood', 'perception_of_productivity', 'minutes_spent_on_distracting_websites', 'minutes_spent_postponing_app_blocks', 'minutes_spent_postponing_habits')",
    );
