...
export class seedTestUserActivitySequences1670205307847 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    VALUES
        ('992f79ca-380a-44fa-9166-eba70251712f', '05809552-fbff-4dea-aca0-93f5d707ac22', 'morning', 
        ...
        ('4cef5086-3d11-4e22-9380-3e50a357bcb9', '05809552-fbff-4dea-aca0-93f5d707ac22', 'evening', 
        ...
        ('592c2feb-2dfd-42c4-9ef2-e7166d8132ed', '05809552-fbff-4dea-aca0-93f5d707ac22', 'breaking', '{"encrypted": "B3SzQak8aSCBnd+6C0hUjCJXZ88q/3BBNtVJ1pap05Id0JWWwHH2NuzN6YqccBeiPMKUrvkB6qOG7dIcPtNdU90yQHrt/90Pk0mlwD4TSxAS/jevo21TfY8WFLefX74IdTDdrk8qKPxC3QDl6XSjWdktDoiPMotZRhFKthru/aKEJzH1bnQl+f+9Om3u2iwY"}', 
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`
        DELETE FROM "activity_sequences" WHERE "user_id" = '05809552-fbff-4dea-aca0-93f5d707ac22';
    `);
  }
}
