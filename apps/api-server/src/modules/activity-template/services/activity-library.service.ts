...
type PredefinedGoalFallbackDefinition = {
  matchers: RegExp[];
  habits: GeneratedHabitSuggestion[];
};

const PREDEFINED_GOAL_FALLBACKS: PredefinedGoalFallbackDefinition[] = [
  {
...
export class ActivityLibraryService {
  ...
  private getPredefinedGoalFallbackHabits(
    ...
    return matchingFallback.habits
      ...
      .slice(0, Math.max(1, options.limit ?? DEFAULT_GENERATED_ACTIVITY_MINUTES));
  }
