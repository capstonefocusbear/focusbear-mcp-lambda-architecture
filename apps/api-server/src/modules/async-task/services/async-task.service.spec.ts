...
describe('AsyncTaskService', () => {
  ...
  describe('createAsyncTask', () => {
    ...
    it('should handle repository errors and capture exception', async () => {
      ...
      await expect(asyncTaskService.createAsyncTask(createDto)).rejects.toThrow(error);
  ...
  describe('findTaskById', () => {
    ...
    it('should handle repository errors and capture exception', async () => {
      ...
      await expect(asyncTaskService.findTaskById(taskId)).rejects.toThrow(error);
      expect(mockCaptureException).toHaveBeenCalledWith(error, {
        level: 'error',
      });
    });
  ...
  describe('updateTaskStatus', () => {
    ...
    it('should throw NotFoundException when task not found during update', async () => {
      ...
      await expect(asyncTaskService.updateTaskStatus(taskId, updateDto)).rejects.toThrow(
        new NotFoundException(`Async task with ID: ${taskId} not found`),
      );
    });
    ...
    it('should handle repository errors and capture exception', async () => {
      ...
      await expect(asyncTaskService.updateTaskStatus(taskId, updateDto)).rejects.toThrow(error);
      expect(mockCaptureException).toHaveBeenCalledWith(error, {
        level: 'error',
      });
    });
  ...
  describe('findTasksByStatus', () => {
    ...
    it('should handle repository errors and capture exception', async () => {
      ...
      await expect(asyncTaskService.findTasksByStatus(status)).rejects.toThrow(error);
      expect(mockCaptureException).toHaveBeenCalledWith(error, {
        level: 'error',
      });
    });
