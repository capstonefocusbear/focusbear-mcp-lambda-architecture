...
@Entity('survey_answer_metadata')
export class SurveyAnswerMetadata extends BaseEntity {
  constructor({ id, ...surveyMetadata }: Partial<SurveyAnswerMetadata> = {}, options = { generateId: false }) {
    super(id, options);
