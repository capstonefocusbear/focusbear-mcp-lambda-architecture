...
export const standaloneHabitPackDummy = {
  ...
  welcome_message: '<p>test welcome message</p>',
...
export const dummyActivityTemplatesForBuildHealthyHabits: ActivityTemplate[] = [
  ...
  },
  {
    ...
    activity_type: ActivityType.morning,
    log_summary_type: LogSummaryType.SUM,
    activity_data: { name: 'Morning Activity 5', video_urls: [], choice_type: ActivityChoiceType.random },
  ...
  },
  {
    ...
    activity_type: ActivityType.evening,
    log_summary_type: LogSummaryType.SUM,
    activity_data: { name: 'Evening Activity 4', video_urls: [], choice_type: ActivityChoiceType.random },
    duration_seconds: 1000,
    parent_id: null,
    choices: [],
  },
