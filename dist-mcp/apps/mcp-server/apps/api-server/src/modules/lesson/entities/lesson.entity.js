...
let Lesson = class Lesson extends base_entity_entity_1.BaseEntity {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { course_id: { required: true, type: () => String }, title: { required: true, type: () => String }, content: { required: true, type: () => String }, url: { required: true, type: () => String }, deleted: { required: true, type: () => Boolean }, course: { required: false, type: () => require("../../course/entities/course.entity").Course } };
    }
};
...
], Lesson.prototype, "deleted", void 0);
__decorate([
