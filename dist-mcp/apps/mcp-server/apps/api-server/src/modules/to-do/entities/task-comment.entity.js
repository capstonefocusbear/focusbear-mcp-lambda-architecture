...
const task_comment_reaction_entity_1 = require("./task-comment-reaction.entity");
const to_do_entity_1 = require("./to-do.entity");
let TaskComment = class TaskComment extends base_entity_entity_1.BaseEntity {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { task_id: { required: true, type: () => String }, user_id: { required: true, type: () => String }, content: { required: true, type: () => String }, task: { required: false, type: () => require("./to-do.entity").ToDo }, user: { required: false, type: () => require("../../user/entities/user.entity").User }, reactions: { required: false, type: () => [require("./task-comment-reaction.entity").TaskCommentReaction] } };
    }
};
...
__decorate([
    (0, typeorm_1.Column)({
        type: 'text',
        nullable: false,
        transformer: base_entity_entity_1.BaseEntity.encryptField('content'),
    }),
    __metadata("design:type", String)
...
__decorate([
    (0, typeorm_1.OneToMany)(() => task_comment_reaction_entity_1.TaskCommentReaction, (reaction) => reaction.comment),
    __metadata("design:type", Array)
], TaskComment.prototype, "reactions", void 0);
